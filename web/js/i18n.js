...
const translations = {
  en: {
    ...
    "player.linkedUser": "Linked user",
    "player.noLinkedUser": "No linked user yet",
    "player.winRate": "Winrate",
    "player.profitChart": "Profit Chart",
    "player.noChartData": "Not enough data for chart",
    ...
    "player.pnl": "PnL",
    "player.avgProfitPerSession": "Avg Profit / Session",
    "player.roi": "ROI",
    "player.avgBuyInPerSession": "Avg Buy-in / Session",
    ...
    "player.hint.avgBuyInPerSession": "Average buy-in per session = Total buy-in amount / Sessions count.",
    "player.hint.winRate": "Share of sessions where this player's PnL is positive.",
  ...
  ru: {
    ...
    "player.linkedUser": "Связанный пользователь",
    "player.noLinkedUser": "Пользователь пока не связан",
    "player.winRate": "Винрейт",
    "player.profitChart": "График профита",
    "player.noChartData": "Недостаточно данных для графика",
    ...
    "player.pnl": "PnL",
    "player.avgProfitPerSession": "Средний профит / сессия",
    "player.roi": "ROI",
    "player.avgBuyInPerSession": "Средний бай-ин / сессия",
    ...
    "player.hint.avgBuyInPerSession": "Средний бай-ин на сессию = сумма бай-инов / количество сессий.",
    "player.hint.winRate": "Доля сессий, где PnL игрока положительный.",
