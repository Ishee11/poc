...
const translations = {
  en: {
    ...
    "telegramBot.waitingTitle": "Confirm sign-in in Telegram",
    "telegramBot.waiting": "Waiting for confirmation in Telegram…",
    "telegramBot.code": "Code:",
    "telegramBot.open": "Open Telegram",
    "telegramBot.cancel": "Cancel",
    "telegramBot.browser": "Sign in through browser",
    "telegramBot.denied": "Sign-in was cancelled in Telegram.",
    "telegramBot.expired": "This sign-in request has expired.",
    "telegramBot.failed": "Could not complete Telegram sign-in.",
    "telegramRecovery.incompleteTitle": "Telegram login was not completed",
    "telegramRecovery.incompleteMessage": "Telegram may be unavailable. Try enabling VPN and start the login again.",
    "telegramRecovery.providerTitle": "Could not reach Telegram",
    "telegramRecovery.providerMessage": "Try again. If Telegram does not open, enable VPN before retrying.",
    "telegramRecovery.cancelledTitle": "Telegram login was cancelled",
    "telegramRecovery.cancelledMessage": "You can restart the login when you are ready.",
    "telegramRecovery.failedTitle": "Telegram login failed",
    "telegramRecovery.failedMessage": "Start the login again. If Telegram is unavailable, try enabling VPN.",
    "telegramRecovery.disabledTitle": "Telegram login is unavailable",
    "telegramRecovery.disabledMessage": "Use another login method or try again later.",
    "telegramRecovery.retry": "Retry",
    "telegramRecovery.dismiss": "Dismiss",
    "guest.player": "Guest session access",
    "guest.noPlayer": "Without selecting a player",
    ...
    "account.telegramLink": "Link Telegram",
    "account.telegramUnlink": "Unlink Telegram",
    "account.telegramUnlinkConfirm": "Unlink Telegram from this account?",
    "account.telegramLinked": "Telegram linked: {name}",
    "account.telegramNotLinked": "Telegram is not linked.",
    ...
    "error.startupNetwork": "The network is unstable. Data will refresh when the connection returns.",
    ...
    "error.telegramAuthFailed": "Telegram authentication failed",
    "error.telegramUnlinkFailed": "Failed to unlink Telegram",
    ...
    "notice.telegramLinked": "Telegram linked to this account.",
    "notice.telegramUnlinked": "Telegram unlinked.",
    "notice.telegramLoginSuccess": "Signed in with Telegram.",
  ...
  ru: {
    ...
    "auth.orEmail": "или войдите по email",
    "telegramBot.waitingTitle": "Подтвердите вход в Telegram",
    "telegramBot.waiting": "Ожидаем подтверждение в Telegram…",
    "telegramBot.code": "Код:",
    "telegramBot.open": "Открыть Telegram",
    "telegramBot.cancel": "Отмена",
    "telegramBot.browser": "Войти через браузер",
    "telegramBot.denied": "Вход отменён в Telegram.",
    "telegramBot.expired": "Запрос на вход истёк.",
    "telegramBot.failed": "Не удалось завершить вход через Telegram.",
    "telegramRecovery.incompleteTitle": "Вход через Telegram не завершён",
    "telegramRecovery.incompleteMessage": "Telegram может быть недоступен. Попробуйте включить VPN и повторить вход.",
    "telegramRecovery.providerTitle": "Не удалось связаться с Telegram",
    "telegramRecovery.providerMessage": "Попробуйте ещё раз. Если Telegram не открывается, включите VPN перед повтором.",
    "telegramRecovery.cancelledTitle": "Вход через Telegram отменён",
    "telegramRecovery.cancelledMessage": "Когда будете готовы, можно начать вход заново.",
    "telegramRecovery.failedTitle": "Не удалось войти через Telegram",
    "telegramRecovery.failedMessage": "Начните вход заново. Если Telegram недоступен, попробуйте включить VPN.",
    "telegramRecovery.disabledTitle": "Вход через Telegram недоступен",
    "telegramRecovery.disabledMessage": "Используйте другой способ входа или попробуйте позже.",
    "telegramRecovery.retry": "Повторить",
    "telegramRecovery.dismiss": "Закрыть",
    "guest.player": "Гостевой доступ к сессиям",
    "guest.noPlayer": "Без выбора игрока",
    ...
    "account.telegramLink": "Привязать Telegram",
    "account.telegramUnlink": "Отвязать Telegram",
    "account.telegramUnlinkConfirm": "Отвязать Telegram от этого аккаунта?",
    "account.telegramLinked": "Telegram привязан: {name}",
    "account.telegramNotLinked": "Telegram пока не привязан.",
    ...
    "error.startupNetwork": "Сеть нестабильна. Данные обновятся после восстановления соединения.",
    ...
    "error.telegramAuthFailed": "Не удалось войти через Telegram",
    "error.telegramUnlinkFailed": "Не удалось отвязать Telegram",
    ...
    "notice.telegramLinked": "Telegram привязан к аккаунту.",
    "notice.telegramUnlinked": "Telegram отвязан.",
    "notice.telegramLoginSuccess": "Вход через Telegram выполнен.",
    "error.sessionNotBalanced":
