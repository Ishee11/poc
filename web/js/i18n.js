...
const translations = {
  en: {
    ...
    "notice.validChipRate": "Enter a valid chip rate.",
    ...
    "modal.startDescription": "Start a new session with chip rate {chipRate}?",
  ...
  ru: {
    ...
    "notice.validChipRate": "Введите корректный курс фишек.",
    ...
    "modal.startDescription": "Начать новую сессию с курсом фишек {chipRate}?",
