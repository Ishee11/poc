...
---
сделать:
куда-то пропал блок Overview, остался только сразу список игроков, верни пожалуйста. в окне сессии
  Session 12.04.2026 вот так пишет, а раньше там был еще айди (именно в заголовке блока, а не отдельным
  полем) - добавь. кнопки Refresh и Leave Workspace в мобильной версии сделай рядом а не друг под другом. в
  списке операций не нужно пользователю видеть айди операции. давай кнопку отмены операции вернем как было
  без красной подсветки, только в саммом подтверждении оставим красное. результаты игроков в виде таблицы
  не удается сделать? в мобильной версии имею ввиду. давай попробуем шрифт поменьше там сделать, чтоб
  поместилось, проверим как будет выглядеть.
